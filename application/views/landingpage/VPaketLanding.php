...
<body id="page-top">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ml-auto">
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="<?= base_url(); ?>Welcome/home">Beranda</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#paket">Paket</a></li>
    ...
    <!-- Masthead-->
    <header class="masthead" style="background-image: url('<?=base_url()?>assets/home/img/header-bg.jpg')">
        <div class="container">
