...
class Pemesanan extends RestController
{
    ...
    {
        $this->db->select('p.NOMOR_PEMESANAN, p2.NAMA_PENGGUNA, k.NAMA_KLIEN, p.TELP_KLIEN, p.ALAMAT_PEMESANAN, p.TGLACARA_PEMESANAN, p.STATUS_PEMESANAN')->order_by('p.created_at', 'desc');
